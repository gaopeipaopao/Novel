package com.example.lib_main.Main.BookShelves;
...
import com.example.lib_main.Main.BookShelves.Collect.BookCollectFragment;
import com.example.lib_main.Main.BookShelves.Join.BookJoinFragment;
import com.example.lib_main.Main.BookShelves.Launch.BookLaunchFragment;
...
public class BookShelvesFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        //打开发起新书的活动
        if(v.getId() == R.id.start_book){


            ARouter.getInstance().build("/simple/myPublishActivity").navigation();
