package com.example.lib_main.Main.News;
...
import com.example.lib_main.Main.News.Chat.NewsChatFragment;
import com.example.lib_main.Main.News.Notify.NewsNotifyFragment;
...
//        tabLayout.setTabMode(TabLayout.MODE_SCROLLABLE);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.news_add) {


        }else if(v.getId() ==  R.id.news_message){
