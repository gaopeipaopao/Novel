...
public class RecycleBinFragment extends Fragment implements NovelCaputrePresenter.CaptureViewInterface{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecycleBinAdapter(getContext(),mDatas);
    ...
    private void getData(){
        if(Util.isNetworkAvailable(getContext())){
            mPresenter.getData(HttpUtil.STATUS_RECYCLE);
        }else {
